...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-[0_0_15px_rgba(212,175,55,0.4)] border border-primary/20",
        destructive:
        ...
        luxury: "bg-gradient-to-r from-yellow-600 via-yellow-400 to-yellow-600 text-black font-bold uppercase tracking-wider hover:brightness-110 shadow-lg border-2 border-yellow-300",
      },
      size: {
