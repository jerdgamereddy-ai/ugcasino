function CInterface(iCurBet,iTotBet,iMoney){
    ...
    this._init = function(iCurBet,iTotBet,iMoney){
        ...
        _oMoneyText = new createjs.Text(TEXT_MONEY +"\n"+Math.floor(iMoney).toLocaleString()+TEXT_CURRENCY,"24px "+FONT_GAME, "#ffde00");
        _oMoneyText.x = 408;
        _oMoneyText.y = 14;
        ...
        _oCoinText = new createjs.Text(Math.floor(iCurBet).toLocaleString() ,"30px "+FONT_GAME, "#ffffff");
        _oCoinText.x =  712;
        ...
        _oTotalBetText = new createjs.Text(TEXT_BET +": "+Math.floor(iTotBet).toLocaleString(),"30px "+FONT_GAME, "#ffffff");
    ...
    this.refreshMoney = function(iMoney){
        _oMoneyText.text = TEXT_MONEY +"\n"+Math.floor(iMoney).toLocaleString()+TEXT_CURRENCY;
    };
    
    this.refreshBet = function(iBet){
        _oCoinText.text = Math.floor(iBet).toLocaleString();
    };
    
    this.refreshTotalBet = function(iTotBet){
        _oTotalBetText.text = TEXT_BET +": "+Math.floor(iTotBet).toLocaleString();
    };
    ...
    this.refreshWinText = function(iWin){
        _oWinText.text = TEXT_WIN + " "+Math.floor(iWin).toLocaleString()+TEXT_CURRENCY;
    };
