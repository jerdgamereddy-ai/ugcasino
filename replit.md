...
- **House Edge**: Administrators can adjust win probabilities per game type and coinflip payout multiplier through the Game Control panel; horse-js has special panel for per-horse odds and max laps; roulette has per-type odds panel; dog-racing has 6-dog individual odds panel; horse4 has 8-horse individual odds panel; Fish Joy has 12-fish multiplier odds panel (FishJoyOddsCard)
